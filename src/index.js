...
// gopikaTwo[37] = '\u0A95';
gopikaTwo[38] = Gujarati.letter_SHA + Gujarati.sign_VIRAMA;
// gopikaTwo[39] = '\u0A95';
// gopikaTwo[40] = '\u0A95';
// gopikaTwo[41] = '\u0A95';
// gopikaTwo[42] = '\u0A95';
...
gopikaTwo[66] = Gujarati.letter_MA + Gujarati.sign_VIRAMA;
// gopikaTwo[67] = '\u0A95';
// gopikaTwo[68] = '\u0A95';
gopikaTwo[69] = Gujarati.letter_II;
// gopikaTwo[70] = '\u0A95';
gopikaTwo[71] = Gujarati.letter_YA + Gujarati.sign_VIRAMA;
gopikaTwo[72] = Gujarati.sign_OM;
gopikaTwo[73] = Gujarati.vowel_SIGN_AI + Gujarati.sign_ANUSVARA;
// gopikaTwo[74] = '\u0A95';
// gopikaTwo[75] = '\u0A95';
gopikaTwo[76] = Gujarati.letter_NA + Gujarati.sign_VIRAMA;
gopikaTwo[77] = Gujarati.letter_SA + Gujarati.sign_VIRAMA;
// gopikaTwo[78] = '\u0A95';
// gopikaTwo[79] = '\u0A95';
...
gopikaTwo[84] = Gujarati.sign_VIRAMA;
...
gopikaTwo[94] = Gujarati.letter_PHA + Gujarati.sign_VIRAMA;
...
gopikaTwo[126] = Gujarati.letter_SHA + Gujarati.sign_VIRAMA;
...
// gopikaTwo[185] = '\u0A95';
gopikaTwo[186] = Gujarati.letter_TA + Gujarati.sign_VIRAMA + Gujarati.letter_RA + Gujarati.sign_VIRAMA;
gopikaTwo[187] = Gujarati.letter_SSA + Gujarati.sign_VIRAMA;
gopikaTwo[188] = Gujarati.letter_BHA;
gopikaTwo[189] = Gujarati.letter_GHA;
gopikaTwo[190] = Gujarati.letter_KHA;
gopikaTwo[191] = Gujarati.letter_GA + Gujarati.sign_VIRAMA + Gujarati.letter_NA + Gujarati.sign_VIRAMA;
// gopikaTwo[192] = '\u0A95';
// gopikaTwo[193] = '\u0A95';
gopikaTwo[194] = Gujarati.vowel_SIGN_I;
gopikaTwo[195] = Gujarati.letter_PA + Gujarati.sign_VIRAMA;
gopikaTwo[196] = Gujarati.letter_DHA;
gopikaTwo[197] = Gujarati.letter_NYA + Gujarati.sign_VIRAMA;
// gopikaTwo[198] = '\u0A95';
gopikaTwo[199] = Gujarati.letter_BHA + Gujarati.sign_VIRAMA;
// gopikaTwo[200] = '\u0A95';
gopikaTwo[201] = Gujarati.letter_VOCALIC_R;
// gopikaTwo[202] = '\u0A95';
gopikaTwo[203] = Gujarati.letter_DA
gopikaTwo[204] = Gujarati.letter_HA + Gujarati.sign_VIRAMA + Gujarati.letter_YA + Gujarati.sign_VIRAMA;
gopikaTwo[205] = Gujarati.letter_JHA;
gopikaTwo[206] = Gujarati.letter_GHA + Gujarati.sign_VIRAMA;
gopikaTwo[207] = Gujarati.letter_KHA + Gujarati.sign_VIRAMA;
// gopikaTwo[209] = '\u0A95';
// gopikaTwo[210] = '\u0A95';
gopikaTwo[211] = Gujarati.letter_HA + Gujarati.sign_VIRAMA + Gujarati.letter_YA + Gujarati.sign_VIRAMA;
gopikaTwo[212] = Gujarati.letter_VA + Gujarati.sign_VIRAMA;
gopikaTwo[213] = Gujarati.letter_LA + Gujarati.sign_VIRAMA;
// gopikaTwo[214] = '\u0A95';
// gopikaTwo[216] = '\u0A95';
gopikaTwo[217] = Gujarati.sign_VIRAMA + Gujarati.letter_RA;
gopikaTwo[218] = Gujarati.letter_THA + Gujarati.sign_VIRAMA;
gopikaTwo[219] = Gujarati.letter_NNA + Gujarati.sign_VIRAMA;
// gopikaTwo[220] = '\u0A95';
// gopikaTwo[221] = '\u0A95';
gopikaTwo[222] = Gujarati.letter_YA;
gopikaTwo[223] = Gujarati.letter_JA + Gujarati.sign_VIRAMA;
// gopikaTwo[224] = '\u0A95';
// gopikaTwo[225] = '\u0A95';
gopikaTwo[226] = Gujarati.sign_VIRAMA + Gujarati.letter_YA;
// gopikaTwo[227] = '\u0A95';
// gopikaTwo[228] = '\u0A95';
gopikaTwo[229] = Gujarati.letter_CA + Gujarati.sign_VIRAMA;
gopikaTwo[230] = Gujarati.letter_DHA + Gujarati.sign_VIRAMA;
gopikaTwo[231] = Gujarati.letter_BA + Gujarati.sign_VIRAMA;
// gopikaTwo[232] = '\u0A95';
gopikaTwo[233] = Gujarati.letter_LLA + Gujarati.sign_VIRAMA;
// gopikaTwo[234] = '\u0A95';
// gopikaTwo[235] = '\u0A95';
// gopikaTwo[236] = '\u0A95';
gopikaTwo[237] = Gujarati.letter_TA + Gujarati.sign_VIRAMA;
...
gopikaTwo[245] = Gujarati.letter_KA + Gujarati.sign_VIRAMA;
// gopikaTwo[246] = '\u0A95';
gopikaTwo[247] = Gujarati.letter_LA;
gopikaTwo[248] = Gujarati.letter_GA + Gujarati.sign_VIRAMA;
gopikaTwo[249] = Gujarati.letter_SHA + Gujarati.sign_VIRAMA + Gujarati.letter_RA + Gujarati.sign_VIRAMA + Gujarati.letter_VA;
// gopikaTwo[250] = '\u0A95';
gopikaTwo[251] = Gujarati.letter_KA + Gujarati.sign_VIRAMA + Gujarati.letter_SSA + Gujarati.sign_VIRAMA;
// gopikaTwo[252] = '\u0A95';
...
rawEditor.bind('input propertychange', function () {
    ...
    for (let i = 0; i < strArr.length; i++) {
        let word = strArr[i];
        const converted = word.length ? parser.convert(word) : ' ';
        unicodeString += converted;
    }

    // var unicodeString = padma.onManualTransform(7, 1);
    // var unicodeString = parser.convert(rawString);
    unicodeEditor.val(unicodeString);
});

rawEditor.val('rðãwík[wtçkfeÞ íkhtøkku{kt Ëkur÷ík Úkíkk rðãwíkûkuºk yLku [wtçkfeÞ ûkuºkLkk MkrËþkuLkk Lk{Lk WËTøk{Úke ËqhLkk rðMíkkh{k');
