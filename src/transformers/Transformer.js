...
var Gopika = require('../encodings/Gujarati/Gopika');
var GopikaTwo = require('../encodings/Gujarati/GopikaTwo');
var Unicode = require('../encodings/Common/Unicode/Unicode');
var DynamicFontParser = require('../parsers/DynamicFontParser');
//Transformer
...
Transformer.dynFont_Gopika_Two = 101;
Transformer.dynFont_Unknown      = 102;  //this should always be the max, this is used as a sentinel
...
Transformer.dynFont_Class[Transformer.dynFont_Gopika_Two]       = GopikaTwo;
...
Transformer.prototype.convert = function (text)
{
    ...
    if (this.input == Transformer.method_DynFonts || 
        ...
        parser = new DynamicFontParser(text, GopikaTwo);
        this.dynFontIndex = Transformer.dynFont_Unknown;
    }
