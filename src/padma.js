...
var Padma_Browser_Transformer = {
    ...
    onManualTransform: function(inputMode, outputMode) {
        ...
        this.transformer.setDynamicFontByName('Gopika');
        ...
        if (result.control) {
            ...
            console.log(this.transformer.convert(result.selection));
            return this.transformer.convert(result.selection);
...
module.exports = Padma_Browser_Transformer;
