...
// var Telugu = require('../../Telugu/Telugu');
// var Malayalam = require('../../Malayalam/Malayalam');
// var Tamil = require('../../Tamil/Tamil');
// var Devanagari = require('../../Devanagari/Devanagari');
var Gujarati = require('../../Gujarati/Gujarati');
// var Kannada = require('../../Kannada/Kannada');
// var Bengali = require('../../Bengali/Bengali');
// var Gurmukhi = require('../../Gurmukhi/Gurmukhi');
var Unicode_Shared = require('../Unicode/Shared');
//Unicode
function Unicode() 
{
    Unicode.initialize();
...
Unicode.initialize = function () {
    Unicode.script_Class[Padma.script_GUJARATI].initialize();
    Unicode.fromPadma[Padma.script_GUJARATI] = Unicode.script_Class[Padma.script_GUJARATI].fromPadma;
...
Unicode.prototype.transformFromPadma = function (str)
{
    ...
    for(var i = 0; i < str.length; ++i) {
        ...
        var out = Unicode.fromPadma[4][cur];
